...
namespace BookShelf.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ISBN,Title,PublishDate,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ISBN,Title,PublishDate,AuthorId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
